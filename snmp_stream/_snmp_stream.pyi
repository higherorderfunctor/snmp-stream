...
class SnmpRequest:
    ...
    def __init__(self, type: SnmpRequestType, host: Text, communities: Sequence[Community], oids: Sequence[ObjectIdentity], ranges: Optional[Sequence[ObjectIdentityRange]] = None, config: Config = None) -> None: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
